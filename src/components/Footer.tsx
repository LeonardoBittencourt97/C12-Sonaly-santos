...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-[#1A1A1A] text-white border-t border-[#7B6253]/30 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <p className="font-body text-xs sm:text-sm text-gray-300 max-w-sm leading-relaxed">
              Atuação especializada e personalizada em Direito Penal, Processo Penal, Direito de Família, Sucessões e Direito do Trabalho. Atendimento humanizado, ético e resolutivo em Curitiba/PR e em todo o Brasil.
            </p>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-[var(--brand-gold)]/40 bg-white/5 text-xs font-heading text-[var(--brand-gold)]">
              ...
              <span>{OFFICE_INFO.lawyerName} • Advocacia Especializada</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <div className="pt-2 flex items-center gap-3">
              <a
                ...
                aria-label={`Instagram da ${OFFICE_INFO.lawyerName}`}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label={`WhatsApp da ${OFFICE_INFO.lawyerName}`}
