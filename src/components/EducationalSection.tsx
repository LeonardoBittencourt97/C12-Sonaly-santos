...
export function EducationalSection() {
  ...
  const getWhatsAppMessageUrl = (topicTitle: string) => {
    const text = `Olá, Dra. Sonaly! Li o conteúdo informativo sobre "${topicTitle}" no seu site e gostaria de esclarecer uma dúvida referente ao meu caso.`;
        ...
        >
          ...
          <div className="max-w-md">
            <p className="font-body text-xs sm:text-sm text-[var(--text-muted)] leading-relaxed">
              Orientações técnicas e informativas sobre direitos penais, de família, sucessões e trabalhistas, pautadas pelo dever de esclarecimento social.
            </p>
            ...
            <div className="pt-5 border-t border-[var(--border-subtle)]/30 flex flex-col sm:flex-row items-center justify-between gap-4 bg-[var(--bg-secondary)]/40 p-4 rounded-xl">
              <div className="text-left">
                ...
                <span className="text-[0.6875rem] font-body text-[var(--text-muted)]">
                  Converse diretamente com a Dra. Sonaly Cristina dos Santos.
                </span>
              </div>
