  ...
  return (
    ...
    >
      ...
      <div ref={bgRef} className="absolute inset-0 w-full h-full pointer-events-none z-0 will-change-transform">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/70 to-black/45 md:from-black/85 md:via-black/45 md:via-50% md:to-transparent" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-transparent to-black/60 md:from-black/35 md:via-transparent md:to-transparent" />
      </div>
      ...
      >
        ...
        <div className="pt-2 sm:pt-4 lg:pt-6 max-w-3xl animate-fade-in-down">
          {/* Badge de Autoridade */}
          <div className="inline-flex items-center gap-2 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full border border-[var(--brand-gold)]/40 bg-black/40 backdrop-blur-md text-xs sm:text-sm font-heading tracking-wide text-[#F9F6F0] mb-4 shadow-sm">
          ...
          <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] leading-[1.14] tracking-tight text-white font-semibold drop-shadow-[0_2px_14px_rgba(0,0,0,0.9)] max-w-3xl">
            Defesa estratégica e acolhimento humano para proteger sua{" "}
            <span className="text-[var(--brand-gold)]">liberdade</span> e seus direitos.
          </h1>
        </div>
        ...
        <div className="pb-2 sm:pb-4 lg:pb-4 max-w-2xl mt-5 sm:mt-6 lg:mt-auto animate-fade-in-up">
          ...
          <p className="font-body text-sm sm:text-base lg:text-lg text-gray-200 max-w-xl leading-relaxed mb-6 font-normal drop-shadow-sm">
            10 anos de prática forense em Direito Penal, Família, Sucessões e Trabalho. Atendimento direto e humanizado com a titular em Curitiba/PR e online.
          </p>

          {/* Os 2 Botões: 1 para WhatsApp da Doutora e 1 para "Conheça seus direitos" (Conteúdo Jurídico) */}
          ...
          <div className="hidden lg:flex items-center gap-5 py-2.5 border-t border-white/15 mt-6 text-white/80 max-w-lg text-xs font-heading">
            ...
            <span>•</span>
            <span>Atendimento Direto com a Titular</span>
          </div>
        </div>
      </div>
    </section>
